        ...
        <div className='h-full w-[15rem] bg-c-2 px-4 py-6'>
          <div className='flex'>
            ...
            <div className='ml-2 w-40'>
              ...
              <span className='text-[13px] text-c-text'>Manage your project</span>
            </div>
          </div>
          <div className='my-5'>
            <BtnWithIcon to={projectId + '/board'} icon='bi:kanban' text='Board' />
            <BtnWithIcon to={projectId + '/issues'} icon='mdi:format-list-checks' text='Issues' />
            <BtnWithIcon to={projectId + '/meet'} icon='mdi:video' text='Meet' />
            <BtnWithIcon to={projectId + ''} icon='clarity:settings-solid' text='Settings' />
          </div>
